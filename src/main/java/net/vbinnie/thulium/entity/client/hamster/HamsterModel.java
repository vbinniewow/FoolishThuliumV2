...
import net.vbinnie.thulium.entity.client.cancerous_rodent.CancerousRodentAnimations;
...
public class HamsterModel<T extends HamsterEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer HAMSTER_MODEL = new EntityModelLayer(Identifier.of(Thulium.MOD_ID, "hamster"), "main");
